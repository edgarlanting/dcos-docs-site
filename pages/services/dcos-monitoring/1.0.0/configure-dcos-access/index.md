---
layout: layout.pug
navigationTitle: Configuring DC/OS access for {{ model.techName }} Service
title: Configuring DC/OS access for {{ model.techName }} Service
menuWeight: 20
excerpt: Configuring DC/OS access for {{ model.techName }} Service
---
